...
public class AiTestMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// aiContentService.registAiContent(new AiContentVO(0,
			// "gmldnjs1616@hanmail.net", "ai222컨텐츠입니다.", "img_url_222", null));
			// aiContentService.modifyAiContent(new AiContentVO(3,
			// "gmldnjs1616@hanmail.net", "수정 컨텐츠입니다.", "수정_img_url_222", null));
