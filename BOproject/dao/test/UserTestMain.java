...
public class UserTestMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// userService.registUser(new UserVO("pratice16@hanmail.net", "33희원",
			// "as33333","서울특별시 강남구", "010-1221-1111"));
			// userService.modifyUser(new UserVO("pratice16@hanmail.net", "수정33희원",
			// "수정as33333","서울특별시 강남구", "010-1221-1111"));
