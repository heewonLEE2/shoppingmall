...
public class ArticleTestMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// articleService.registArticle(new ArticleVO(0, "gmldnjs1616@hanmail.net", "두번째
			// 게시물", "두번째 게시물 내용입니다.", 0, null, "101,201,301", null));
			// articleService.modifyArticle(new ArticleVO(2, "gmldnjs1616@hanmail.net","수정
			// 두번째 게시물", "수정 두번째 게시물 내용입니다.", 1, null, "101,201,301", null));
