...
public class OrderTestMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// orderService.registOrder(new OrderVO(0, 1, "gmldnjs1616@hanmail.net",
			// 2,33000,"서울특별시 잠실구", "0601,0702",null));
			// orderService.modifyOrder(new OrderVO(3, 1, "gmldnjs1616@hanmail.net",
			// 4,44000,"수정 서울특별시 잠실구", "0601,0702",null));
