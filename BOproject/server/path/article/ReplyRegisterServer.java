...
public class ReplyRegisterServer implements HttpHandler {
	...
	public void handle(HttpExchange exchange) {
		try {
			...
			ArticleService articeService = new ArticleServiceImpl();
			...
			if ("GET".equalsIgnoreCase(method)) {
				...
				ArticleVO articleVO = articeService.getArticle(aid);
				List<ReplyVO> replyList = service.selectArticleReply(aid);
				List<UserVO> userList = userService.listUser();
				responseMap.put("article", articleVO);
				responseMap.put("reply", replyList);
